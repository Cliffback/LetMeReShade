...
class Plugin:
    ...
    async def load_shader_preferences(self) -> dict:
        ...
        try:
            ...
            # Migrate from old file if exists
                ...
                with open(old_preferences_file) as f:
            ...
            try:
                ...
                if version_file.exists():
                    with open(version_file) as f:
                        ...
                        # Extract version number (e.g., "6.6.0_Addon" -> "6.6.0")
                        import re
    ...
    async def run_install_reshade(self, with_addon: bool = False, version: str = "6.6.0", with_autohdr: bool = False, selected_shaders: list | None = None) -> dict:
        try:
            assets_dir = self._get_assets_dir()
    ...
    async def install_reshade_for_heroic_game(self, game_path: str, dll_override: str = "d3d9", selected_executable_path: str = "") -> dict:
        ...
        try:
            ...
            if os.path.exists(reshade_ini_src):
                ...
                with open(reshade_ini_src, encoding='utf-8') as f:
                    ini_content = f.read()
